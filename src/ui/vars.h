...
extern int32_t get_var_gear();
extern void set_var_gear(int32_t value);
extern int32_t get_var_rpm();
extern void set_var_rpm(int32_t value);
extern int32_t get_var_coolant_temp();
extern void set_var_coolant_temp(int32_t value);
extern int32_t get_var_mph();
extern void set_var_mph(int32_t value);
